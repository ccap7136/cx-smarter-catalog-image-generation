    ...
    'STYLED': {
        ...
        'POULTRY': """
                ...
                - Preparation:
                  ...
                  Depict the meat as pre-cut into raw-style cubes 
                  (uniform, clean-edged pieces typical of cutting before cooking), 
                  but shown in its cooked state with appropriate color, texture, and doneness.
                """
        },
    'RAW': {
        'SEAFOOD':
